  ...
  render() {
    ...
    <div className="Toggle" style={{textAlign:"center"}}>
        ...
        <div id="profile" style={{display:"none", flexDirection:"column", margin:"20px 15px" }}>
            <img src={this.state.imgSrc} alt="profile photo" style={{width:"200px",height:"230px",borderRadius:"200px", marginLeft:"auto", marginRight:"auto"}}/>
            <h1 style={{color:"salmon", fontStyle:"oblique" }}>{this.state.fullName}</h1>
            <h3>{this.state.profession}</h3>
            <p>{this.state.bio}</p>
        </div>
        <button onClick={this.handleClick} style={{width: "50%",color:"#800000",border: "none",padding: "15px 32px",textAlign:"center",fontSize:"25px",margin:"4px 2px",cursor:"pointer",boxShadow:"0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19)"}}>
